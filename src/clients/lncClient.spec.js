...
/** FAILS 403 */
test("Should be able to delete an invoice", function (t) { return __awaiter(_this, void 0, void 0, function () {
...
test("Should be able to get our nodes peers", function (t) { return __awaiter(_this, void 0, void 0, function () {
    var listPeers, peers;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
test("Should be able no route yet between node and an arbitrary node", function (t) { return __awaiter(_this, void 0, void 0, function () {
    var getRoute;
    return __generator(this, function (_a) {
