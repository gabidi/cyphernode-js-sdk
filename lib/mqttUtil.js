 ...
 */
const cypherNodeMqttSub = ({ host = process.env.CYPHERNODE_MQTT_BROKER || "localhost", port = process.env.CYPHERNODE_MQTT_PORT || 1883, mqttClient = mqtt_1.default.connect({
    host,
    protocol: "mqtt",
