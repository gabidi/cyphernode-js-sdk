  ...
  export class MatrixClient extends EventEmitter {
    ...
    joinRoom(
      ...
      opts: {
        ...
        viaServers: Array<string>; // <string> The server names to try and join through in addition to those that are automatically chosen.
      },
      callback: MatrixCallback
    ): Promise<Room>;
    kick(
    ...
    upgradeRoom(
      roomId: string,
      newVersion: string
    ): Promise<{ replacement_room: object }>;
    uploadContent(
      file: Buffer,
      opts: {
