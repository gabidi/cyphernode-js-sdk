...
const cypherNodeMatrixTransport = async ({
    ...
    const get = (command: CypherNodeCommand, payload: any) => _sendCommand({ method: "GET", command, payload });
    const post = (command: CypherNodeCommand, payload: any) => _sendCommand({ method: "POST", command, payload });
