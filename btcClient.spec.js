...
BTC tests
*/
ava_1.serial("Should be able to get a new bitcoin address", (t) => __awaiter(this, void 0, void 0, function* () {
    const { context: { getNewAddress } } = t;
    const address = yield getNewAddress();
    t.is(address.length, 34);
    t.is(address[0], "3");
}));
ava_1.serial("Should be able to get the latest block's hash", (t) => __awaiter(this, void 0, void 0, function* () {
    const { context: { getBestBlockHash } } = t;
    const blockHash = yield getBestBlockHash();
    t.is(blockHash.length, 64);
}));
ava_1.serial("Should be able to get the latest block's info", (t) => __awaiter(this, void 0, void 0, function* () {
...
ava_1.serial("Should be able to get a transactions info", (t) => __awaiter(this, void 0, void 0, function* () {
